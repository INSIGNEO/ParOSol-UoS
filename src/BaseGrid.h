...
public:
  ...
  //! Index of the nodes loaded with bodyforce. A node has 4 values (x,y,z,d) (d: direction)
  std::vector<unsigned short> bodyforce_coordinates;
  //! contains the bodyforce values
  std::vector<float> bodyforce_values;
